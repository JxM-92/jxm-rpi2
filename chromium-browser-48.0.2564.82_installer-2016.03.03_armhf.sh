...
sudo apt-get -y install gconf-service libgconf-2-4 libgnome-keyring0 libnspr4 libnss3 xdg-utils youtube-dl coreutils libc6 libx11-6 x11-common xauth xterm xinit
